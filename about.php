    ...
    <div class="row">
      <div class="col-md-3 col-sm-6">
        <div class="full team_blog_colum">
          <div class="it_team_img"> <img class="img-responsive" src="assets/images/it_service/ankit.jpg" alt="#"> </div>
          <div class="team_feature_head">
            <h4>Ankit Kumar Singh</h4>
            <h3>Founder & CEO</h3>
          </div>
          <div class="team_feature_social">
            <div class="social_icon">
              <ul class="list-inline">
                <li><a class="fab fa-facebook" href="https://www.facebook.com/" title="Facebook" target="_blank"></a></li>
                <li><a class="fab fa-google" href="https://plus.google.com/" title="Google+" target="_blank"></a></li>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="full team_blog_colum">
          <div class="it_team_img"> <img class="img-responsive" src="assets/images/it_service/team-member-1.jpg" alt="#"> </div>
          <div class="team_feature_head">
            <h4>Sudan Bhattarai</h4>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="full team_blog_colum">
          <div class="it_team_img"> <img class="img-responsive" src="assets/images/it_service/shreya.JPG" alt="#"> </div>
          <div class="team_feature_head">
            <h4>Shreya Karn</h4>
            <h3>Manager</h3>
          </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="full team_blog_colum">
          <div class="it_team_img"> <img class="img-responsive" src="assets/images/it_service/siddrtha.jpg" alt="#"> </div>
          <div class="team_feature_head">
            <h4>Siddhartha Bajracharya</h4>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="full team_blog_colum">
          <div class="it_team_img"> <img class="img-responsive" src="assets/images/it_service/kamal.jpeg" alt="#"> </div>
          <div class="team_feature_head">
            <h4>Kamal Chamlagain</h4>
            <h3>Web Developer</h3>
          </div>
          <div class="team_feature_social">
            <div class="social_icon">
      ...
      <div class="col-md-3 col-sm-6">
        <div class="full team_blog_colum">
          <div class="it_team_img"> <img class="img-responsive" src="assets/images/it_service/ayush.jpg" alt="#"> </div>
          <div class="team_feature_head">
            <h4>Aayush Timalsina</h4>
            <h3>Web Developer</h3>
          </div>
          <div class="team_feature_social">
            <div class="social_icon">
